...
<head>
    ...
    <title>Utilizadores - Gestão de Loja</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="card">
            <button onclick="novoUtilizador()" class="btn btn-primary" style="margin-bottom: 20px;">
                + Novo Utilizador
            </button>

            <table class="tabela" id="tabela-utilizadores">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Nome</th>
